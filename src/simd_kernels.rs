...
pub fn adam_step_f32(
    ...
    unsafe {
        ...
        let vbc1_inv = vdupq_n_f32(1.0 / bc1);
        let vbc2_inv = vdupq_n_f32(1.0 / bc2);
        ...
        for i in 0..chunks {
            ...
            let m_hat = vmulq_f32(new_m, vbc1_inv);
            let v_hat = vmulq_f32(new_v, vbc2_inv);

            // Fast approximate rsqrt via vrsqrteq_f32 + one Newton step
            ...
            // update = lr * m_hat * rsqrt(v_hat + eps) — avoids div and sqrt
            let update = vmulq_f32(vlr, vmulq_f32(m_hat, rsqrt_refined));
